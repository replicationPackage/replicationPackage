...
public class Step1_1_ParseNames {
    public static void main(String[] args) throws Exception {
        ...
        Util.deleteIfExist(new File(Step1_2_FilterNamesAndConstructContext.filteredName));
        ...
        if (singleFile) {
            ...
            //String projectsPath = "C:\\PHDONE\\ASE19\\1000PROJECTS";
            String projectsPath = "C:\\PHDONE\\ASE19\\testProject0\\pmd-5.2.0";
          //  Util.deleteIfExist(new File(Config.outFile));
            parseFilesWithProgress(projectsPath);
        }

        System.out.println(Step1_2_FilterNamesAndConstructContext.totalNum);
       // System.out.println(Step1_2_FilterNamesAndConstructContext.criterion1Num);
        System.out.println(Step1_2_FilterNamesAndConstructContext.criterion2Num);
       // System.out.println(Step1_2_FilterNamesAndConstructContext.heuNum);
        System.out.println(Step1_2_FilterNamesAndConstructContext.dicNum);
