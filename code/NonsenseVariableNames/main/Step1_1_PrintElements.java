...
/**
 * ForVariable name
 * ParameterVariable name parameterNames methodName
 * RegularVariable name type methodName context
 */
        ...
        for (RegularVariable regularVariable :
            ...
            for (IdentifierWithoutType identifierWithoutType : elementsNeedPrint) {
                if (identifierWithoutType.getLine() != regularVariable.getLine() &&
                        Math.abs(identifierWithoutType.getLine() - regularVariable.getLine()) <= Step1_2_FilterNamesAndConstructContext.contextLine) {
